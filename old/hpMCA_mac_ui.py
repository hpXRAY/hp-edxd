...
class Ui_hpMCA(object):
    def setupUi(self, hpMCA):
        ...
        self.btnOn = QtWidgets.QPushButton()
        self.btnOff = QtWidgets.QPushButton()
        self.btnErase = QtWidgets.QPushButton()
        ...
        self.lblLiveTime_lbl = QtWidgets.QLabel("Live",self.groupBoxElapsed)
        self.lblRealTime_lbl = QtWidgets.QLabel("Real",self.groupBoxElapsed)
        self.lblLiveTime = pvQLabel()
        self.lblRealTime = pvQLabel()
        self.PRTM_pv = pvQDoubleSpinBox()
        self.PLTM_pv = pvQDoubleSpinBox()
        self._groupBoxElapsedLayout.addWidget(self.lblLiveTime_lbl,0,0)
        self._groupBoxElapsedLayout.addWidget(self.lblRealTime_lbl,1,0)
        self._groupBoxElapsedLayout.addWidget(self.lblLiveTime,0,1)
        self._groupBoxElapsedLayout.addWidget(self.lblRealTime,1,1)
        self._groupBoxElapsedLayout.addWidget(self.PLTM_pv,0,2)
        self._groupBoxElapsedLayout.addWidget(self.PRTM_pv,1,2)
        ...
        self.actionDisplay = QtGui.QAction(hpMCA)
        ...
        self.actionPressure = QtGui.QAction(hpMCA)
