...
class Ui_hpMCA(object):
    def setupUi(self, hpMCA):
        ...
        self.lineROI.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        ...
        self.folder_lbl = EliderLabel(mode=QtCore.Qt.TextElideMode.ElideLeft)
        ...
        self.last_saved_lbl = EliderLabel('', mode=QtCore.Qt.TextElideMode.ElideLeft)
        self.last_saved_lbl.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        start_num_lbl.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        min_digits_lbl.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        date_format_lbl.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        time_format_lbl.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        dt_format_lbl.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        self.indexLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
